...
const Login = () => {
    ...
    <div className="flex-grow border-t border-gray-400"></div>
                    ...
                    <div className="flex items-start mb-5">
                       ...
                       <p className="text-[#605BFF]">Reset Password?</p>
                       </div>
                    </div>
                    <div>
                        <button type="submit" className=" w-full bg-yellow-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-10 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Log in</button>
                    </div>
                    <h2 className='mt-4 text-center text-sm'>Don't have an account? <Link className='text-[#605BFF] hover:underline' to='/signup'>New Account</Link> </h2>
                </form>
